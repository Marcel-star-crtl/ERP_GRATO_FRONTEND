...
//   // NEW: State for suppliers and items from database
//   const [suppliers, setSuppliers] = useState([]);
//   const [items, setItems] = useState([]);
//   const [itemCategories, setItemCategories] = useState([]);
//   const [supplierSearchTerm, setSupplierSearchTerm] = useState('');
...
//   // NEW: Load suppliers from Supplier database
//   const loadSuppliers = async () => {
//     try {
//       console.log('=== LOADING SUPPLIERS FROM DATABASE ===');
//       const response = await buyerRequisitionAPI.getSuppliers({
...
//   // NEW: Load items from Items database
//   const loadItems = async () => {
//     try {
//       console.log('=== LOADING ITEMS FROM DATABASE ===');
//       const response = await buyerRequisitionAPI.getItems({
//         limit: 200 // Get more items for selection
//       });
...
//   // NEW: Search items for autocomplete
//   const searchItems = async (searchText) => {
//     if (!searchText || searchText.length < 2) {
//       setItemSearchOptions([]);
//       return;
...
//   // NEW: Handle item selection from database
//   const handleItemSelect = (value, option, index) => {
//     const selectedItem = option.item;
//     const formItems = createPOForm.getFieldValue('items') || [];
...
//           ...item,
//           totalPrice: item.quantity * item.unitPrice,
//           // Include itemId if selected from database
//           ...(item.itemId && { itemId: item.itemId })
//         })),
//         totalAmount,
//         currency: values.currency || 'XAF',
...
//         notification.success({
//           message: 'Purchase Order Created',
//           description: `PO ${response.data.purchaseOrder.poNumber} has been created with supplier ${selectedSupplier.name}.`,
//           duration: 5
//         });
...
//       {/* Create New PO Modal - ENHANCED WITH DATABASE INTEGRATION */}
//       <Modal
//         title={
//           <Space>
//             <PlusOutlined />
...
//             {selectedPO.notes && (
//               <Card size="small" title="Notes" style={{ marginBottom: '16px' }}>
//                 <div style={{ padding: '8px', background: '#f5f5f5', borderRadius: '4px' }}>
//                   <Text>{selectedPO.notes}</Text>
//                 </div>
//               </Card>
...
//         notification.success({
//           message: 'Purchase Order Created',
//           description: `PO ${response.data.purchaseOrder.poNumber} has been created successfully.`,
//           duration: 5
//         });
...
//         notification.success({
//           message: 'PO Sent Successfully',
//           description: `Purchase order ${selectedPO.poNumber} has been sent to the supplier via email.`,
//           duration: 5
//         });
...
//                     if (supplier) {
//                       createPOForm.setFieldsValue({
//                         supplierName: supplier.supplierDetails?.companyName || supplier.fullName,
...
//                       <br />
//                       <small style={{ color: '#666' }}>{supplier.email}</small>
//                     </Option>
//                   ))}
//                 </Select>
//               </Form.Item>
...
//           {/* Hidden fields for supplier details */}
//           <Form.Item name="supplierName" hidden />
//           <Form.Item name="supplierEmail" hidden />
//           <Form.Item name="supplierPhone" hidden />
...
//             {/* Activity Timeline */}
//             {selectedPO.activities && selectedPO.activities.length > 0 && (
//               <Card size="small" title="Activity History" style={{ marginBottom: '16px' }}>
//                 <Timeline>
//                   {selectedPO.activities.map((activity, index) => (
//                     <Timeline.Item key={index}>
//                       <Text strong>{activity.description}</Text>
//                       <br />
//                       <Text type="secondary">
//                         by {activity.user} • {moment(activity.timestamp || activity.date).format('MMM DD, YYYY HH:mm')}
//                       </Text>
//                     </Timeline.Item>
//                   ))}
//                 </Timeline>
