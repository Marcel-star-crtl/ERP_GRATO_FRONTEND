...
//     supplierEmail: 'sales@techsource.cm',
//     supplierPhone: '+237 678 901 234',
//     submissionDate: '2024-12-16T14:30:00Z',
//     validUntil: '2024-12-23T23:59:59Z',
//     status: 'received',
//     totalAmount: 2350000,
//     currency: 'XAF',
//     deliveryTime: 5,
...
//     },
//     items: [
//       { description: 'Wireless Mouse', quantity: 10, unitPrice: 25000, totalPrice: 250000, specifications: 'Rechargeable, 7 days battery' },
//       { description: 'USB Keyboards', quantity: 15, unitPrice: 35000, totalPrice: 525000, specifications: 'Standard layout, wired' },
//       { description: 'VGA to HDMI Converter', quantity: 5, unitPrice: 45000, totalPrice: 225000, specifications: 'High quality conversion' },
//       { description: 'External Hard Drive 500GB', quantity: 3, unitPrice: 450000, totalPrice: 1350000, specifications: 'USB 3.0, portable' }
//     ],
//     notes: 'All items are brand new with manufacturer warranty',
//     attachments: ['quote_techsource_001.pdf', 'specifications.pdf']
//   },
//   {
//     id: 'QUO002',
//     requisitionId: 'REQ20241215001',
//     supplierId: 'SUP003',
//     supplierName: 'Central Africa Tech Hub',
//     supplierEmail: 'procurement@catechhub.com',
//     supplierPhone: '+237 677 555 123',
//     submissionDate: '2024-12-16T16:45:00Z',
...
//     },
//     items: [
//       { description: 'Wireless Mouse', quantity: 10, unitPrice: 28000, totalPrice: 280000, specifications: 'Premium quality, 10 days battery' },
//       { description: 'USB Keyboards', quantity: 15, unitPrice: 38000, totalPrice: 570000, specifications: 'Ergonomic design, backlit' },
//       { description: 'VGA to HDMI Converter', quantity: 5, unitPrice: 42000, totalPrice: 210000, specifications: 'Premium conversion quality' },
//       { description: 'External Hard Drive 500GB', quantity: 3, unitPrice: 520000, totalPrice: 1560000, specifications: 'USB 3.1, shock resistant' }
//     ],
//     notes: 'Premium quality products with extended warranty',
//     attachments: ['quote_catech_001.pdf']
//   },
//   {
//     id: 'QUO003',
...
//     supplierEmail: 'sales@medsupplypro.cm',
//     supplierPhone: '+237 699 876 543',
//     submissionDate: '2024-12-15T11:20:00Z',
//     validUntil: '2024-12-22T23:59:59Z',
//     status: 'evaluated',
//     totalAmount: 2950000,
//     currency: 'XAF',
//     deliveryTime: 2,
...
//       totalScore: 83.5,
//       evaluated: true,
//       evaluatedBy: 'Current Buyer',
//       evaluationDate: '2024-12-16T10:00:00Z',
//       notes: 'High quality medical supplies with excellent delivery time'
//     },
//     items: [
//       { description: 'Medical Gloves', quantity: 100, unitPrice: 1500, totalPrice: 150000, specifications: 'Latex-free, sterile' },
//       { description: 'Surgical Masks', quantity: 500, unitPrice: 800, totalPrice: 400000, specifications: 'N95 equivalent protection' },
//       { description: 'Hand Sanitizer', quantity: 50, unitPrice: 2500, totalPrice: 125000, specifications: '70% alcohol content' },
//       { description: 'Digital Thermometer', quantity: 10, unitPrice: 25000, totalPrice: 250000, specifications: 'Non-contact, FDA approved' }
//     ],
//     notes: 'All medical supplies are certified and meet international standards',
//     attachments: ['quote_medsupply_001.pdf', 'certificates.pdf']
//   }
// ];
...
//   const getStatusTag = (status) => {
//     const statusMap = {
//       'received': { color: 'blue', text: 'Received', icon: <FileTextOutlined /> },
//       'evaluated': { color: 'green', text: 'Evaluated', icon: <CheckCircleOutlined /> },
//       'selected': { color: 'success', text: 'Selected', icon: <TrophyOutlined /> },
//       'rejected': { color: 'red', text: 'Rejected', icon: <CloseCircleOutlined /> },
//       'expired': { color: 'default', text: 'Expired', icon: <ExclamationCircleOutlined /> },
...
//       // Calculate total score based on weights (you can make these configurable)
//       const weights = { quality: 0.4, cost: 0.35, delivery: 0.25 };
//       const totalScore = (
//         values.qualityScore * weights.quality +
//         values.costScore * weights.cost +
...
//                 evaluated: true,
//                 evaluatedBy: 'Current Buyer',
//                 evaluationDate: moment().toISOString()
//               }
//             }
//           : quote
//       );
...
//     Modal.confirm({
//       title: 'Select Quote',
//       content: `Are you sure you want to select the quote from ${quote.supplierName} for XAF ${quote.totalAmount.toLocaleString()}?`,
//       onOk: async () => {
//         setLoading(true);
//         try {
//           // Update quote status
...
//             q.id === quote.id 
//               ? { ...q, status: 'selected' }
//               : q.requisitionId === quote.requisitionId
//               ? { ...q, status: 'rejected' }
//               : q
//           );
//           setQuotes(updatedQuotes);
          
//           message.success(`Quote from ${quote.supplierName} has been selected!`);
//         } catch (error) {
//           message.error('Failed to select quote');
//         } finally {
//           setLoading(false);
//         }
//       }
...
//     switch (activeTab) {
//       case 'received':
//         return quotes.filter(q => q.status === 'received');
//       case 'evaluated':
//         return quotes.filter(q => q.status === 'evaluated');
//       case 'selected':
//         return quotes.filter(q => q.status === 'selected');
//       case 'expired':
//         return quotes.filter(q => moment(q.validUntil).isBefore(moment()));
//       default:
//         return quotes;
//     }
//   };
...
//     evaluated: quotes.filter(q => q.status === 'evaluated').length,
//     selected: quotes.filter(q => q.status === 'selected').length,
//     expired: quotes.filter(q => moment(q.validUntil).isBefore(moment())).length
//   };
...
//           loading={loading}
//           rowSelection={{
//             selectedRowKeys: selectedQuotes,
//             onChange: setSelectedQuotes,
//             getCheckboxProps: (record) => ({
//               disabled: record.status === 'rejected' || record.status === 'expired'
//             })
//           }}
//           pagination={{
//             pageSize: 10,
...
//                   <Text type="secondary" style={{ fontSize: '12px' }}>
//                     Evaluated by {selectedQuote.evaluation.evaluatedBy} on {moment(selectedQuote.evaluation.evaluationDate).format('MMM DD, YYYY HH:mm')}
//                   </Text>
//                 </div>
//               </Card>
//             )}
...
//             <Card size="small" title="Additional Information" style={{ marginBottom: '16px' }}>
//               <div style={{ marginBottom: '16px' }}>
//                 <Text strong>Supplier Notes:</Text>
//                 <div style={{ marginTop: '8px', padding: '8px', background: '#f5f5f5', borderRadius: '4px' }}>
//                   <Text>{selectedQuote.notes}</Text>
//                 </div>
//               </div>
...
//                   <List
//                     size="small"
//                     dataSource={selectedQuote.attachments}
