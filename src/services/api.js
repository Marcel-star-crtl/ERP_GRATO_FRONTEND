...
export const itSupportAPI = {
  getDashboardStats: async () => {
    try {
      ...
      const response = await api.get('/api/it-support/dashboard/stats');
  ...
  getRequestsByRole: async (params = {}) => {
    try {
      ...
      const response = await api.get('/api/it-support/role/requests', { params });
  ...
  getEmployeeRequests: async (params = {}) => {
    try {
      ...
      const response = await api.get('/api/it-support/employee', { params });
  ...
  getSupervisorRequests: async (params = {}) => {
    try {
      ...
      const response = await api.get('/api/it-support/supervisor', { params });
  ...
  getITDepartmentRequests: async (params = {}) => {
    try {
      ...
      const response = await api.get('/api/it-support/it-department', { params });
  ...
  getFinanceRequests: async (params = {}) => {
    try {
      ...
      const response = await api.get('/api/it-support/finance', { params });
  ...
  getAllRequests: async (params = {}) => {
    try {
      ...
      const response = await api.get('/api/it-support/admin', { params });
  ...
  createMaterialRequest: async (requestData) => {
    try {
      ...
      const response = await api.post('/api/it-support', formData, {
        headers: {
  ...
  getRequestById: async (requestId) => {
    try {
      const response = await api.get(`/api/it-support/${requestId}`);
      return response.data;
    } catch (error) {
  ...
  processSupervisorDecision: async (requestId, decision) => {
    try {
      const response = await api.put(`/api/it-support/${requestId}/supervisor`, decision);
      return response.data;
    } catch (error) {
  ...
  processITDepartmentDecision: async (requestId, decision) => {
    try {
      const response = await api.put(`/api/it-support/${requestId}/it-department`, decision);
      return response.data;
    } catch (error) {
  ...
  updateFulfillmentStatus: async (requestId, statusData) => {
    try {
      const response = await api.put(`/api/it-support/${requestId}/fulfillment`, statusData);
      return response.data;
    } catch (error) {
  ...
  processFinanceDecision: async (requestId, decision) => {
    try {
      const response = await api.put(`/api/it-support/${requestId}/finance`, decision);
      return response.data;
    } catch (error) {
  ...
  updateRequest: async (requestId, updateData) => {
    try {
      const response = await api.put(`/api/it-support/${requestId}`, updateData);
      return response.data;
    } catch (error) {
  ...
  deleteRequest: async (requestId) => {
    try {
      const response = await api.delete(`/api/it-support/${requestId}`);
      return response.data;
    } catch (error) {
  ...
  saveDraft: async (draftData) => {
    try {
      const response = await api.post('/api/it-support/draft', draftData);
      return response.data;
    } catch (error) {
  ...
  getApprovalChainPreview: async (department, employeeName) => {
    try {
      const response = await api.post('/api/it-support/preview-approval-chain', {
        department,
        employeeName
      });
      return response.data;
  ...
  downloadAttachment: async (requestId, fileName) => {
    try {
      const response = await api.get(`/api/it-support/${requestId}/attachment/${fileName}`, {
        responseType: 'blob',
      });
      return response.data;
    } catch (error) {
